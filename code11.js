...
gdjs.FinalCode.asyncCallback17400916 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.FinalCode.asyncCallback17400916(runtimeScene, asyncObjectsList)));
}
}
